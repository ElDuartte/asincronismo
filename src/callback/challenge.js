...
function fetchData(url_api, callback) {
  ...
  xhttp.onreadystatechange = function (event) {
    ...
    if (xhttp.readyState === 4) {
      //verificamos que el status este en 200, significa que todo esta bien, no 400 0 500
      if (xhttp.status === 200) {
        //el primer valor es el error, y el siguiente el resultado
